...
app.post('/atras', function (req, res) {
  fs.writeFile('status.txt', 'atras', function (err) {
    if (err) throw err;
...
app.post('/detener', function (req, res) {
  fs.writeFile('status.txt', 'detener', function (err) {
    if (err) throw err;
    console.log('Cambiado!');
  });
  res.sendFile(__dirname + "/interfaz.html");
});
app.post('/adelante', function (req, res) {
  fs.writeFile('status.txt', 'adelante', function (err) {
    if (err) throw err;
    console.log('Cambiado!');
  });
  res.sendFile(__dirname + "/interfaz.html");
